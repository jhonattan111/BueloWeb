<template>
  <div class="h-screen overflow-hidden bg-background text-foreground flex flex-col">
    <!-- Header bar -->
    <header class="h-10 flex items-center justify-between border-b border-border px-3 shrink-0">
    ...
    >
      ...
      <main class="lg:hidden flex flex-col min-h-0 overflow-hidden absolute inset-0">
        <slot name="editor" />
      </main>
    </div>
  </div>
