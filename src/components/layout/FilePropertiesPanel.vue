...
<template>
  <section class="flex h-full flex-col overflow-hidden bg-background/90">
    <header class="flex items-center justify-between px-3 h-9 shrink-0 border-b border-border">
    ...
    <div class="p-3 text-xs space-y-2 overflow-auto">
      <p v-if="!selectedNode" class="text-muted-foreground">Select a file or folder in Explorer.</p>
